...
func (hub *Arbre) Initialisation() {
	...
	//partie droite
	hub.Centre.Droite.Centre.Droite.Gauche.Droite.Centre.Droite.Inserer(map[string]string{"nom": "Réserve d'arme", "monstre_nombre": "3", "monstre_type": "Champion mort-vivant", "feu": "false", "forge": "false", "loot": "1"}, hub.Centre.Droite.Centre.Droite.Gauche.Droite.Centre.Gauche)
	...
	hub.Centre.Droite.Centre.Droite.Gauche.Droite.Centre.Gauche.Gauche.Centre.Droite.Droite.Inserer(map[string]string{"nom": "Toit de la réserve d'arme", "monstre_nombre": "7", "monstre_type": "Champion mort-vivant", "feu": "false", "forge": "false", "loot": "0"}, hub.Centre.Droite.Centre.Droite.Gauche.Droite.Centre.Gauche.Gauche.Centre)
